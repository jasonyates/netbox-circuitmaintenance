...
class CircuitMaintenanceModelTest(TestCase):
    ...
    def test_get_absolute_url(self):
        ...
        self.assertEqual(
            url, f"/plugins/maintenance/circuitmaintenance/{self.maintenance.pk}/"
        )
    ...
    def test_get_status_color(self):
        ...
        for status, expected_color in status_colors.items():
            ...
            self.assertEqual(
                self.maintenance.get_status_color(),
                expected_color,
...
class CircuitMaintenanceImpactModelTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.circuit_type = CircuitType.objects.create(name="Transit", slug="transit")
...
class CircuitMaintenanceNotificationsModelTest(TestCase):
    ...
    def test_get_absolute_url(self):
        ...
        self.assertEqual(
            url, f"/plugins/maintenance/circuitnotification/{self.notification.pk}/"
        )
