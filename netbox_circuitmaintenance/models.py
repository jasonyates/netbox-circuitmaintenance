...
class CircuitMaintenanceTypeChoices(ChoiceSet):
    ...
    # From BCOP standard: https://github.com/jda/maintnote-std/blob/master/standard.md
...
class CircuitMaintenance(NetBoxModel):
    ...
    status = models.CharField(
        max_length=30, choices=CircuitMaintenanceTypeChoices, db_index=True
    )
...
class CircuitMaintenanceNotifications(NetBoxModel):
    ...
    email_received = models.DateTimeField(verbose_name="Email Received")
